        ...
        {loading ? (
          ...
          <div>
            {cars?.map((car, index) => (
              <div
                key={index}
                className="flex justify-between items-center flex-wrap gap-2 sm:grid grid-cols-[2fr_2fr_1fr_1fr] lg:grid-cols-[0.5fr_2fr_2fr_1fr_1fr] px-6 py-3 text-sm font-semibold bg-primary text-gray-50 border-b border-slate-900/10"
              >
                ...
                <div>
                  <label className="relative inline-flex items-center gap-3 cursor-pointer text-gray-900">
                    <input
